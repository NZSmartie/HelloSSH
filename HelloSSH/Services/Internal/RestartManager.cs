...
namespace HelloSSH.Services.Internal
{
    ...
    public static class RestartManager
    {
        ...
        public static RmResult RegisterResources(int dwSessionHandle, uint nFiles, string[] rgsFilenames, uint nApplications, RM_UNIQUE_PROCESS[] rgApplications, uint nServices, string[] rgsServiceNames)
        ...
        /// </param>
        /// <returns>This is the most recent error received. The function can return one of the system error codes that are defined in Winerror.h.</returns>
        public static RmResult StartSession(out int pSessionHandle, int dwSessionFlags, string strSessionKey)
            => RmStartSession(out pSessionHandle, dwSessionFlags, strSessionKey);
        ...
        /// <param name="dwSessionHandle">A handle to an existing Restart Manager session.</param>
        /// <returns>This is the most recent error received. The function can return one of the system error codes that are defined in Winerror.h.</returns>
        public static RmResult EndSession(int dwSessionHandle)
